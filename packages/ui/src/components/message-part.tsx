...
function toolDefaultOpen(tool: string, shell = false, edit = false) {
  if (tool === "shell" || tool === "bash") return shell
...
const shellRender: ToolComponent = (props) => {
  const i18n = useI18n()
  ...
  return (
    ...
    >
      <div data-component="shell-output">
        ...
        <div data-slot="shell-scroll" data-scrollable>
          <pre data-slot="shell-pre">
            <code>{text()}</code>
          </pre>
        </div>
      </div>
